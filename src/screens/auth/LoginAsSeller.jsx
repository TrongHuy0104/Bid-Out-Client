...
export const LoginAsSeller = () => {
    ...
    const { isLoading, isSuccess, isLoggedIn, user, message, isError } =
    ...
    //         navigate('/dashboard');
    //     }
    // }, [dispatch, isError, isLoggedIn, navigate]);
    return (
        <>
            {isLoading && <Loader />}
                    ...
                    <Container>
                        <div>
                            ...
                            <div className="flex items-center gap-3">
                                <Title
                                    level={5}
                                    className="text-green font-normal text-xl"
                                >
                                    Home
                                </Title>
                                <Title
                ...
                >
                    <div className="text-center">
                        ...
                        <p className="mt-2 text-lg">
                            ...
                            <CustomNavLink href="/create-account">
                                Signup Here
                            </CustomNavLink>
                        </p>
                    </div>
